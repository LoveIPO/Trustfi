<template>
  <div class="notice">
    <vHead :title="$t('set.lang3')" :back="back"></vHead>
    <div class="box">
      <van-list v-model:loading="loading" :finished="finished" :immediate-check="false" :finished-text="$t('index.lang3')"
        @load="onLoad">
        <div class="list">
...
export default {
  ...
  methods: {
    ...
    onLoad() {
      ...
      Home.help_list(parme).then((res) => {
        if (res.code == 200) {
          for (let i = 0; i < res.data.data.legnth; i++) {
