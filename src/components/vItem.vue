  ...
  <div class="vItem flex-wrap flex-ver ">
    ...
    <div class="list flex-con">
      <div v-for="(i, index) in list" :key="index">
        <div class="item" @click="link(i.id)">
          <div class="title flex-wrap jb a-items">
            ...
            <div class="state flex-wrap a-items">
              ...
              <p style="color: #2EBD87;" v-if="i.state == 1">{{$t('pulb.lang12')}}</p>
              <p style="color: #FFA200;" v-if="i.state == 2">{{$t('pulb.lang13')}}</p>
          ...
          <div class="content flex-wrap ">
            <div class="num">
              <p class="key">{{$t('invest.lang16')}}</p>
              <p class="val">{{ i.number }}</p>
            </div>
            <div class="income">
              <p class="key">{{$t('invest.lang13')}}</p>
              <p class="val">{{ i.profit_ratio * 100 }}%</p>
            </div>
            <div class="period">
